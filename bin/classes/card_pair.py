...
# image_list = load.Load.load_images_resize("D:/Daniel's Files/Downloads/Coding/Westmount/Grade_12_CS/ICS4U1-01/Games/Chan_Wars/resources/chans", size) + \
#              [pg.transform.scale(pg.image.load("D:/Daniel's Files/Downloads/Coding/Westmount/Grade_12_CS/ICS4U1-01/Games/Chan_Wars/resources/card_back_PNG.png"), size)]
# background = pg.transform.scale(pg.image.load("D:/Daniel's Files/Downloads/Coding/Westmount/Grade_12_CS/ICS4U1-01/Games/Chan_Wars/resources/background.jpg"), (X, Y))
