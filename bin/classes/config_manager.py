                            ...
                            self.level_confs[i] = {
                                ...
                                'boss': {
                                    'moves': {'basic_1': {'phrases': ['For My Lost Love!', 'World Shaking Explosion Fist!', 'North Star Spear!'], 'damage': 15,
                                              ...
                                              'special': {'phrases': ["That's a neat little hack that I found!", "With this hack, I'll steal your health for myself.", "I hope you're prepared for this.", "You know, I'm something of a scientist myself."],
                                ...
                                'enemies':
                                    ...
                                    'drowned': {'hp': 30, 'name': 'Drowned Chan',
                                                'attacks': {'drowned_glare': {'phrase': 'Drowned Glare', 'damage': 0, 'block': 0, 'buff': 'None', 'heal': 0, 'status': ['Fear', 1]},
                                                            'bloated_breath': {'phrase': 'Bloated Breath',  'damage': 0, 'block': 0, 'buff': 'None', 'heal': 0, 'status': ['Vulnerable', 1]},
                                    ...
                                    'goblin': {'hp': 30, 'name': 'Goblin Chan',
                                               'attacks': {'evasive_maneuvers': {'phrase': 'Evasive Maneuvers','damage': 0, 'buff': 'None', 'heal': 0,'status': 'None', 'block': 10},
                                ...
                                'level_2':
                                    ...
                                    'enemies':
                                        ...
                                        'drowned': {'hp': 40, 'name': 'Drowned Chan',
                                                    'attacks': {'drowned_glare': {'phrase': 'Drowned Glare', 'damage': 0, 'block': 0, 'buff': 'None', 'heal': 0, 'status': ['Fear', 2]},
                                                                'bloated_breath': {'phrase': 'Bloated Breath',  'damage': 0, 'block': 0, 'buff': 'None', 'heal': 0, 'status': ['Vulnerable', 1]},
                                        ...
                                        'goblin': {'hp': 35, 'name': 'Goblin Chan',
                                                   'attacks': {'evasive_maneuvers': {'phrase': 'Evasive Maneuvers','damage': 0, 'buff': 'None', 'heal': 0,'status': 'None', 'block': 20},
                                                               'tiny_stab': {'phrase': 'Tiny Stab', 'block': 0, 'buff': 'None', 'heal': 0, 'status': 'None', 'damage': 10},
                        ...
                        case 2:
                            self.level_confs[i] = {
                                ...
                                'drowned': {'hp': 50, 'name': 'Drowned Chan',
                                            'attacks': {'drowned_glare': {'phrase': 'Drowned Glare', 'damage': 0, 'block': 0, 'buff': 'None', 'heal': 0, 'status': ['Fear', 2]},
                                                        'bloated_breath': {'phrase': 'Bloated Breath',  'damage': 0, 'block': 0, 'buff': 'None', 'heal': 0, 'status': ['Vulnerable', 1]},
                                                        'corpse_explosion': {'phrase': 'Corpse Explosion', 'block': 0, 'status': 'None', 'buff': 'None', 'heal': -50, 'damage': 50}}},
                                ...
                                'goblin': {'hp': 50, 'name': 'Goblin Chan',
                                           'attacks': {'evasive_maneuvers': {'phrase': 'Evasive Maneuvers','damage': 0, 'buff': 'None', 'heal': 0,'status': 'None', 'block': 25},
                                                       'tiny_stab': {'phrase': 'Tiny Stab', 'block': 0, 'buff': 'None', 'heal': 0, 'status': 'None', 'damage': 10},
                                                       'hamstring': {'phrase': 'Hamstring', 'damage': 0, 'buff': 'None', 'heal': 0, 'block': 0, 'status': ['Weakness', 3]}}},
